pipeline {
    ...
    environment {
        ...
        GIT_URL = 'https://github.com/msprepsidev/ptk_customers'
        PROJECT_DIR = 'ptk_customers'
    }
    ...
    post {
        always {
           ...
           success {
                mail to: 'ambetty21@gmail.com', subject: 'Build Succeeded', body: 'The build was a success.'
            }
            failure {
                mail to: 'ambetty21@gmail.com', subject: 'Build Failed', body: 'The build failed.'
            }
        }
    }
}
